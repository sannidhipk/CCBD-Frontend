...
function uploadPhoto() {
   ...
   var image = getBinary(file).then(
     ...
     console.log(data);
     var apigClient = apigClientFactory.newClient({
         apiKey: "xEXj12jg4c6EvxTHldpt15hlAQLg1EF4rrKzuaR8"
     });

     var body = data;
     var params = {"folder" : "photos-bucket-s3", "item" : file.name, 'Content-Type': file.type, 'x-amz-meta-customLabels': labels};
     var additionalParams = {};
     console.log(params);
